...
////////////////////////////////////////////////////////////////
SubmitVrEyeCommand::SubmitVrEyeCommand(int eye, const CameraParameters& camera_parameters)
    : eye_(eye),
...
////////////////////////////////////////////////////////////////
SubmitVrEyeCommand::~SubmitVrEyeCommand() = default;

////////////////////////////////////////////////////////////////
void SubmitVrEyeCommand::exec() const
{
#ifdef OCULUS
    ...
    oculus_data.submitEye(eye_, camera_parameters_);
#endif
}
